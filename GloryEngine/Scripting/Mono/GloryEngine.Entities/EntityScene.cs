...
namespace GloryEngine.Entities
{
    ...
    public class EntityScene : Scene
    {
        ...
        public EntitySceneObject NewEntityObject() => (EntitySceneObject)NewEmptyObject();
        ...
        /// <returns>The newly created object</returns>
        public EntitySceneObject NewEntityObject(string name) => (EntitySceneObject)NewEmptyObject(name);

        /// <summary>
        /// Get an entity object in the scene
        /// </summary>
        /// <param name="index">Index of the object</param>
        public EntitySceneObject GetEntitySceneObjectAt(uint index) => (EntitySceneObject)GetSceneObjectAt(index);
        ...
        /// <returns></returns>
        public EntitySceneObject GetEntitySceneObject(UInt64 objectID) => (EntitySceneObject)GetSceneObject(objectID);
        ...
        public EntitySceneObject InstantiateEntityPrefab(EntityPrefab prefab, SceneObject parent = null)
            => (EntitySceneObject)InstantiatePrefab(prefab, parent);
        ...
        public EntitySceneObject InstantiateEntityPrefab(EntityPrefab prefab, Vector3 position, Quaternion rotation, Vector3 scale, SceneObject parent = null)
            => (EntitySceneObject)InstantiatePrefab(prefab, position, rotation, scale, parent);
