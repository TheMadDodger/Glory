...
namespace Glory
{
	...
	EntityComponentObject::EntityComponentObject(Utils::ECS::EntityID entityID, UUID componentID, uint32_t componentType, Utils::ECS::EntityRegistry* pRegistry)
	...
	Utils::ECS::EntityRegistry* EntityComponentObject::GetRegistry() const
	{
		return m_pRegistry;
	}

	const Utils::ECS::EntityID EntityComponentObject::EntityID() const
	{
		return m_EntityID;
	}
