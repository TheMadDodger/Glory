project "GloryCore"
	...
	vpaths
	{
		...
		["Resources"] = { "PrefabData.*", "MaterialData.*", "MaterialInstanceData.*", "MaterialPropertyInfo.*", "TextureData.*", "MeshData.*", "ModelData.*", "ImageData.*", "FileData.*", "CubemapData.*", "FontData.*", "FontDataStructs.*", "PipelineData.*" },
