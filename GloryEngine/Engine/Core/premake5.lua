project "GloryCore"
	...
	vpaths
	{
		...
		["Resources"] = { "PrefabData.*", "MaterialData.*", "MaterialInstanceData.*", "MaterialPropertyInfo.*", "TextureData.*", "MeshData.*", "ModelData.*", "ImageData.*", "HDRImageData.*", "FileData.*", "CubemapData.*", "FontData.*", "FontDataStructs.*", "PipelineData.*" },
