project "GloryCore"
	...
	vpaths
	{
		...
		["Resources"] = { "ShaderCrossCompiler.*", "ShaderSourceData.*", "InternalResource.h", "ImageData.*", "MaterialData.*", "MaterialPropertyData.*", "MaterialInstanceData.*", "MaterialPropertyInfo.*", "MeshData.*", "ModelData.*", "TextureData.*" },
