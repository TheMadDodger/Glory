project "GloryEditor"
	...
	vpaths
	{
		...
		["Editor/Editors/Component"] = { "TransformEditor.*", "ScriptedComponentEditor.*", "DefaultComponentEditor.*", "EntityComponentEditor.*", "EntityComponentPopup.*", "EntitySceneObjectEditor.*" },
