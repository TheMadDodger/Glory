...
namespace Editor
{
    ...
    public:
         ...
         */
        GLORY_EDITOR_API static void SerializeScene(EditorApplication* pApp, GScene* pScene, Utils::NodeValueRef node);
        /**
         ...
         */
        GLORY_EDITOR_API static void SerializeSceneSettings(EditorApplication* pApp, GScene* pScene, Utils::NodeValueRef node);
        /**
