...
namespace Glory::Editor
{
	...
	public:
		...
		static GLORY_EDITOR_API void RegisterChangeHandler(const std::string& extensionOrName, const std::string& pathComponent, std::function<void(Utils::YAMLFileRef&, const std::filesystem::path&)> handler);
