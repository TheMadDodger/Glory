...
SubmodoleDirs["GLEW"]				= "%{rootDir}/third-party/glew-2.2.0"
SubmodoleDirs["shaderc"]			= "%{rootDir}/submodules/shaderc"
SubmodoleDirs["spirv_cross"]		= "%{rootDir}/submodules/SPIRV-Cross"
...
IncludeDir["shaderc"]				= "%{SubmodoleDirs.shaderc}/libshaderc/include"
IncludeDir["spirv_cross"]			= "%{SubmodoleDirs.spirv_cross}"
