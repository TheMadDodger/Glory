...
SubmodoleDirs["ImGuiTestEngine"]		= "%{rootDir}/submodules/imgui_test_engine/imgui_test_engine"
...
IncludeDir["ImGuiTestEngine"]			= "%{SubmodoleDirs.ImGuiTestEngine}"
...
LibDirs["ImGuiTestEngine"]				= "%{SubmodoleDirs.ImGuiTestEngine}/lib/%{cfg.buildcfg}/%{cfg.platform}"
...
group "Dependencies"
	...
	include "third-party/imgui_test_engine"
...
group "Editor/Extensions"
	...
	include "Editor/Extensions/TestEngineExtension"
