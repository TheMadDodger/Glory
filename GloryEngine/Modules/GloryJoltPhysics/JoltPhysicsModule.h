...
namespace Glory
{
	...
	public:
		...
		/* RayCast */
		GLORY_API bool CastRay(const Ray& ray, RayCastResult& result, float maxDistance, const LayerMask& layerMask, const std::vector<uint32_t>& ignoreBodyIDs) const override;
