...
namespace Glory
{
	inline const std::map<PixelFormat, GLuint> Formats = {
	...
	inline const std::map<PrimitiveType, GLuint> PrimitiveTypes =
	{
	...
	inline const std::map<Filter, GLint> Filters = {
	...
	inline const std::map<SamplerAddressMode, GLint> Texturewraps = {
	...
	inline const std::map<DataType, GLenum> Datatypes = {
	...
	inline const std::map<CompareOp, GLenum> CompareOps = {
	...
	inline const std::map<Func, GLenum> GLFuncs = {
	...
	inline GLint GetMinFilter(Filter mipMap, Filter minFilter)
	{
		switch (mipMap)
		{
	...
	inline GLuint GetShaderStageFlag(ShaderType shaderType)
	{
		switch (shaderType)
		{
	...
	inline GLuint GetGLImageType(ImageType imageType)
	{
		switch (imageType)
		{
